...
- https://cheonglimsaju.com/kfortune-launch.html
...
- 2026-05-16T17:19:38+09:00: after adding `kfortune-launch.html`, `scripts/submit-indexnow.sh` returned `HTTP/2 200` from `https://api.indexnow.org/indexnow`.
